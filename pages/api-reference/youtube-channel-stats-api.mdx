...
```json
{
  ...
  "data": {
    ...
    "nickname": "SocialKit",
    "signature": "Extract video summaries, transcripts, comments, and engagement metrics from YouTube, TikTok, Instagram, and more.",
    "verified": false,
