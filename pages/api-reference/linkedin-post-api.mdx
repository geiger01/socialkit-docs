...
```json
{
	...
	"data": {
		...
		"post": {
			...
			"images": [
				"https://media.licdn.com/dms/image/D4E22AQF_example/feedshare-shrink_1280/0/1719000000000"
			],
			"videoUrl": null,
			"publishedAt": "2026-06-18T11:00:00.000Z",
			"author": {
				"name": "Jeff Weiner",
				"headline": "Founding Partner Next Play Ventures; Former CEO at LinkedIn",
				"profileUrl": "https://www.linkedin.com/in/jeffweiner08/"
			}
		}
	}
}
...
- **`post`**: Object containing the full post data
  ...
  - **`imageUrl`**: URL to the post's primary image, or empty string if no image is attached
  - **`images`**: Array of all image URLs attached to the post
  ...
  - **`author`**: Object containing `name`, `headline`, and `profileUrl` of the post author
