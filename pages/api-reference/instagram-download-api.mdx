...
The Instagram Video Download API lets you download Reels, regular video posts, and IGTV in multiple formats and qualities. Returns a temporary, pre-signed download URL with title, duration, thumbnail, and file size. Same request shape as the [YouTube Download API](/api-reference/youtube-download-api) and [TikTok Download API](/api-reference/tiktok-download-api).
...
- `url`: The original Instagram URL you submitted
- `title`: The video title or caption
- `duration`: Human-readable video duration (`MM:SS`)
