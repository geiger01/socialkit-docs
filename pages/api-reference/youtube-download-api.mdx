...
Route the download through a specific country, for region-locked videos. Accepts a 2-letter ISO code (`GR`, `IL`, `DE`) or a country name (`Greece`, `Germany`). Example: a video only available in Greece downloads with `"country": "GR"`.
