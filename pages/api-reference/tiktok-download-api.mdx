...
> **Downloading a long video?** Use the [Async Download API (v2)](/api-reference/async-download-api) — submit a job and poll for the result. It's built for long or large videos that would time out a single request.
