...
- **Video Transcripts** - Extract accurate transcripts from YouTube, TikTok, and Instagram videos for content analysis and accessibility.
- **Video Comments** - Retrieve and analyze comments from YouTube videos with sorting and filtering options.
- **Video Stats** - Get engagement metrics including views, likes, and comment counts from YouTube, TikTok, and Instagram videos.
- **Channel Stats** - Retrieve comprehensive channel statistics including followers, verification status, and profile information for TikTok and Instagram.
- **Custom AI Analysis** - Use custom prompts and response fields to extract specific insights tailored to your needs.
- **Multi-Platform Support** - Analyze content from YouTube, TikTok, and Instagram with a unified API.
